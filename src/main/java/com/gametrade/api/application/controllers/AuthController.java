...
public class AuthController {
    ...
    @PostMapping("/login")
    public ResponseEntity<?> login(@Valid @RequestBody LoginRequest loginForm) throws AppException {
        return new ResponseEntity<>(authService.auth(loginForm.getEmail(), loginForm.getPassword()), HttpStatus.OK);
    }
